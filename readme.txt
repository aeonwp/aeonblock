...
AeonBlock includes support for Infinite Scroll in Jetpack.
...
Removed function aeonblock_post_thumbnail which was oly used in one place.
Removed a reference to aeonblock-small-thumb because this custom image size was never set.
...
Removed aeonblock_excerpt_more, increased the default excerpt size to 45, removed the upper excerpt size limit.
Removed Bootstrap.
Removed animate.
...
== Theme License ==
AeonBlock WordPress Theme, Copyright 2021 Aeon Theme
AeonBlock is distributed under the terms of the GNU General Public License v2 or later.
